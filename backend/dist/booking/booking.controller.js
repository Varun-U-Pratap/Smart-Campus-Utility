...
let BookingController = class BookingController {
    ...
    availabilityGrid(from, to) {
        return this.bookingService.availabilityGrid(from, to);
    }
    create(user, dto) {
        return this.bookingService.createBooking(user.sub, dto);
    }
    updateStatus(bookingId, user, dto) {
        return this.bookingService.updateStatus(bookingId, user.sub, user.role, dto);
    }
};
...
], BookingController.prototype, "listRooms", null);
__decorate([
    (0, common_1.Get)('grid'),
    (0, roles_decorator_1.Roles)(client_1.Role.STUDENT, client_1.Role.ADMIN),
    ...
    __metadata("design:returntype", void 0)
], BookingController.prototype, "availabilityGrid", null);
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)(client_1.Role.STUDENT, client_1.Role.ADMIN),
